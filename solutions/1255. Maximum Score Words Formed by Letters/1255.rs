...
impl Solution {
  pub fn max_score_words(words: Vec<String>, letters: Vec<char>, 
                         score: Vec<i32>) -> i32 {
    ...
    fn use_word(word: &str, count: &mut HashMap<char, i32>, 
                score: &[i32]) -> i32 {
    ...
    fn dfs(words: &[String], s: usize, count: &mut HashMap<char, i32>, 
           score: &[i32]) -> i32 {
      let mut ans = 0;
